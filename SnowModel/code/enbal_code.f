...
c      else
c        read(98,*) albedo
c        if (snow_d.eq.0.0) then
c         albedo = 0.0
c        endif
c      endif
c END J.PFLUG
c      if (albedo.lt.al_min) albedo=al_min
