...
c      real icefrac_z(nz_max)
     ...
     &  run_snowtran,sfc_sublim_flag,seaice_run,Cp_water,ro_adjust
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &  mLayerVolFracLiqTrial,fc_param,t_avg,ro_adjust
...
c Compute the snow density change due to settling.
     ...
     &    snow_depth,ro_water,ro_ice,ro_adjust)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &  swe_depth_star,ro_ice,ro_water,swe_depth,ro_adjust
C Grunes additions
...
C   Ro_adjust is adjusted in the .par file
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &  Cp_water,ml_ret,icorr_factor_index,corr_factor,ro_adjust)
...
c Compute the snow density change due to compaction.
     ...
     &  T_old,JJ,dy_snow,A1,A2,ro_adjust)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &  T_old,JJ,dy_snow,A1,A2,ro_adjust)
      ...
      real A1,A2,ro_water,ro_ice,dt,Tf,ro_adjust
...
c     ro_adjust = 0.4
      ...
      if (JJ.gt.0) then
        ...
        do j=1,JJ
          ro_layer(j) = ro_layer(j) + ro_adjust * dt *
     &      (A1 * sweqstar(j) * ro_layer(j) *
